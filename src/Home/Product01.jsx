...
class Product01 extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <>
        <div className='product-page' id="product02">
      <div className={`product-layout-wrapper ${className}`}>
        <div className="product-layout">
        <div className={`${className}-image-wrapper-start`}>
              <img src='https://g2.vdnlink.cn/1707014825715.jpeg' loading="lazy" />
          </div>
          <QueueAnim className={`${className}-content-wrapper`} delay={300} ease="easeOutQuart">
            <h1 key="h2">
            企业类国际办公网络方案
            </h1>
            <p key="p">为全球企业提供高效稳定的国际办公网络方案。专线级网络服务能实现全球任意两点间的快速、稳定连接，无论访问国内还是国外，都能无感切换、智能分流。让您的全球总部与分支机构轻松实现网络互联互通，无忧访问全球总部IT服务及资源，真正实现全球范围内的协同办公。</p>
            <p className='pf'>企业级国际办公网络，快速、稳定、全球互联！</p>
            <span key="button">
              <Button
                type="primary"
                onClick={() => {
